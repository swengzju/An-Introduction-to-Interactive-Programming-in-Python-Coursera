...
class Sprite:
    ...
    def collide(self, other_object):
        if dist(self.pos, other_object.pos) > self.radius + other_object.radius:
            return False
        elif dist(self.pos, other_object.pos) <= self.radius + other_object.radius:
            return True
...
def draw(canvas):
    ...
    if group_collide(rock_group, my_ship) and lives >= 1:
        lives -= 1
